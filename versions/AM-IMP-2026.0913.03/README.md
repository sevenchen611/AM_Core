...
Production verification confirmed the expired direct URL now renders the recovery page and that
the recovery marker survives the Rental login redirect for post-login SSO issuance.
