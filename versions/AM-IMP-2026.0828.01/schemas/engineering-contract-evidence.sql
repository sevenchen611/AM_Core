...
VALUES (true, '2026-08-28.engineering-contract-evidence.v2')
...
-- Shared Engineering contract templates are independent from project contract
-- instances. Template versions are append-only source records; applying one to
-- a project creates a separate contract_version snapshot and never links the
-- signing evidence back to mutable template metadata.
