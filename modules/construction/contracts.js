...
function finalArtifactHtml(version){if(WORKFLOW.row.signingStatus!=='completed')return '';return '<div class="workflow-box final-artifact"><h4>最終簽署文件</h4><div class="hint">甲乙雙方簽署與最終歸檔均已完成；系統會在開啟時重新驗證私有權限與 SHA-256。</div><div class="workflow-actions"><a class="btn" target="_blank" rel="noopener" style="text-decoration:none" href="'+esc(internalDocumentHref(version,'final-signed-pdf'))+'">開啟最終簽署合約 PDF</a><a class="rowbtn" target="_blank" rel="noopener" style="text-decoration:none;display:inline-block" href="'+esc(internalDocumentHref(version,'evidence-receipt'))+'">開啟簽署證據收據</a></div></div>';}
