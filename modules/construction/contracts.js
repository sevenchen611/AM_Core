...
function contractDocumentsHtml(version){const internal=internalPreviewHtml(version);if(WORKFLOW.row.signingStatus!=='completed')return internal;return finalArtifactHtml(version)+internal.replace('內部審查文件（唯讀）','簽署前凍結版本與附件').replace('開啟完整合併合約 PDF','開啟簽署前完整合併 PDF');}
