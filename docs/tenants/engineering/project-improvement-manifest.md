...
| AM-IMP-2026.0901.07 | Installed | Contractor required details and Word-like contract PDF tables | Mandatory contractor name/identity number/address, immutable evidence, Word table preservation, and clean party/payment grids | Signing, issuance, completion, PDF extraction, and visual A4 rendering checks pass locally. Production deployment verification is pending. |
