...
| AM-IMP-2026.0830.01 | Ready | Engineering draft-review status hotfix | Unambiguous PostgreSQL send/open transitions and evidence-preserving recovery | Awaiting production deployment and recovery verification; recovery must not resend LINE. |
