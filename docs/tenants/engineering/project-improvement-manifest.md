...
| AM-IMP-2026.0901.10 | Installed | Visible attachment removal and LINE archive recovery | Always-visible red × controls plus an explicit archive-count warning and prominent historical LINE backfill action | Workspace, LINE archive, archive schema, draft-review, and cumulative management dry-runs pass; production deployment pending. |
