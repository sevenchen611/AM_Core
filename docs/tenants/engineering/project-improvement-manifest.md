...
| AM-IMP-2026.0901.03 | Installed | Contractor identity-document evidence | Mandatory ID-card front/back capture at formal signing, private Drive storage, immutable hashes and receipt verification | Both sides are required before signing; images remain private and only receipt times plus SHA-256 hashes appear in the signed PDF and evidence receipt. Production deployment verification is pending. |
