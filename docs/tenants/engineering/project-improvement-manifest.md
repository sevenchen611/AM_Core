...
| AM-IMP-2026.0831.03 | Installed | Contract internal review preview | Read-only merged PDF and protected original attachments in Engineering AM | Local dry-runs verify view-only routes, watermarked merged output, review history, source hash checks, and no LINE or review-record side effects. Production deployment is pending. |
