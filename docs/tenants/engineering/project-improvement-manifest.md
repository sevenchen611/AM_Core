...
| AM-IMP-2026.0831.02 | Installed | Contract draft and review controls | Return internal review to draft, clear action results, stage-specific draft errors, and accurate overview workflow status | Implemented and verified locally. Production deployment and live UI verification remain before this row can become `Deployed`. |
