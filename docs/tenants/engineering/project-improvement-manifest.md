...
| AM-IMP-2026.0831.01 | Installed | Cross-version contract review history | Version-labelled feedback timeline on the public page and merged draft PDF | Completed feedback from earlier versions is shown chronologically without overwriting contradictory opinions. Existing links use existing Engineering review rows; production deployment is pending. |
