...
| AM-IMP-2026.0830.04 | Ready | Mobile contract PDF attachment opening | Attachment-style file cards and protected new-window POST opening without iframe/blob | Awaiting production deployment and mobile-facing UI verification. |
