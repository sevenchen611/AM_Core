...
| AM-IMP-2026.0916.01 | Installed | External and internal claims group modes | External vendor groups use applicant-bound legacy claim forms without Finance V3 onboarding; internal groups retain V3 identity and membership controls | Local implementation and verification complete. Production deployment and initial classification remain pending. |
