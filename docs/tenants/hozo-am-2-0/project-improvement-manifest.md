...
| AM-IMP-2026.0915.02 | Installed | LINE group member claim auto-onboarding | Allow an observed member of an active published claims group unless individually disabled, and provision a claim-only external Finance identity on first use | Local AM authority, dynamic recipient routing, Rental bridge, legacy/V3 compatibility and privacy tests pass; production deployment and one-group canary await explicit publication authorization. |
