...
| AM-IMP-2026.0914.07 | Installed | Named personal claim templates | Let each verified LINE identity keep up to 20 named reusable templates for each of the three legacy LIFF forms and the V3 standard form | Code and schema are installed on isolated feature branches. Templates exclude dates, service months, invoice numbers, receipts, OCR state, submission state and raw LINE IDs. |
