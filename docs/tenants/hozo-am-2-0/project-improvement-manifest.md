...
| AM-IMP-2026.0819.01 | Ready | Claim line accounting classification V2 | Explicit category, service month and business-unit confirmation with accounting preview and paid-claim reclassification | Local form, payload and governance checks pass. Deploy Rental first, then AM Platform, and verify a fresh production LIFF page before changing this status to `Deployed`. |
