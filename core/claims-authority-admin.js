...
export function createClaimsAuthorityAdminHandler({ authority, resolveContext, resolveTarget, listTargets, verifyMutation, syncDiscovery = async () => ({ ok: true, scanned: 0, verified: 0 }), basePath = '/claims-authority' } = {}) {
